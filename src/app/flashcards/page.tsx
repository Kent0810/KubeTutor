    ...
    <main className="flex-1 bg-gray-50">
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          <p className="animate-slide-in-left text-sm font-semibold tracking-[0.2em] text-blue-600 uppercase">
            Study mode
          </p>
          <h1 className="animate-fade-in-up delay-100 mt-3 text-4xl font-bold text-slate-900">Flashcard Review</h1>
