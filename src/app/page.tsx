      ...
      <section className="bg-slate-900 text-white">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-4 text-5xl leading-tight font-bold tracking-tight lg:text-6xl">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="rounded-3xl bg-blue-600 p-10 text-center text-white shadow-xl">
          ...
          <p className="mt-4 text-base leading-7 text-blue-100">
            Create a free account to save your progress, take quizzes, and track what you&apos;ve
            learned.
          </p>
